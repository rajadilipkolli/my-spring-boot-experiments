...
class CustomerControllerIT extends AbstractIntegrationTest {
    ...
    class MultiTenantDataIsolationTests {
        ...
        void shouldMaintainDataIsolationBetweenTenants() throws Exception {
            ...
            createTestCustomersForTenant(
                    TENANT_1, "Tenant1 Customer1", "Tenant1 Customer2", "Tenant1 Customer3");
        ...
        void shouldNotAllowCrossTenantAccess() throws Exception {
            ...
            List<Customer> tenant1Customers =
                    createTestCustomersForTenant(TENANT_1, "Tenant1 Customer");
            Customer tenant1Customer = tenant1Customers.get(0);

            // Create customer in tenant2
            List<Customer> tenant2Customers =
                    createTestCustomersForTenant(TENANT_2, "Tenant2 Customer");
            Customer tenant2Customer = tenant2Customers.get(0);

            // Tenant1 should be able to access its own customer
            mockMvc.perform(
                            get("/api/customers/{id}", tenant1Customer.getId())
            ...
            mockMvc.perform(
                            get("/api/customers/{id}", tenant2Customer.getId())
                                    .param("tenant", TENANT_1))
    ...
    class Tenant1CrudOperationsTests {
        ...
        void shouldFetchAllCustomersForTenant1() throws Exception {
            createTestCustomersForTenant(
                    TENANT_1, "First Customer", "Second Customer", "Third Customer");
    ...
    class Tenant2CrudOperationsTests {
        ...
        void shouldFindCustomerByIdForTenant2() throws Exception {
            List<Customer> customers =
                    createTestCustomersForTenant(TENANT_2, "Tenant2 Test Customer");
            Customer customer = customers.get(0);
        ...
        void shouldUpdateCustomerForTenant2() throws Exception {
            List<Customer> customers =
                    createTestCustomersForTenant(TENANT_2, "Original Tenant2 Customer");
            Customer customer = customers.get(0);
        ...
        void shouldDeleteCustomerForTenant2() throws Exception {
            List<Customer> customers =
                    createTestCustomersForTenant(TENANT_2, "Tenant2 Customer to Delete");
            Customer customer = customers.get(0);
    ...
    class ValidationAndErrorHandlingTests {
        ...
        void shouldReturn403WhenAccessingWithInvalidTenant() throws Exception {
            mockMvc.perform(get("/api/customers").param("tenant", "invalid"))
    ...
    class ElaborateTenant2SpecificTests {
        ...
        void shouldPerformCompleteCrudLifecycleForMultipleCustomersInTenant2() throws Exception {
            ...
            mockMvc.perform(
                            put("/api/customers/{id}", createdCustomer1.getId())
                                    .param("tenant", TENANT_2)
                                    .contentType(MediaType.APPLICATION_JSON)
            ...
            mockMvc.perform(
                            put("/api/customers/{id}", createdCustomer2.getId())
                                    .param("tenant", TENANT_2)
                                    .contentType(MediaType.APPLICATION_JSON)
            ...
            mockMvc.perform(
                            get("/api/customers/{id}", createdCustomer1.getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.name", is("Tenant2 Enterprise Customer - VIP")));

            mockMvc.perform(
                            get("/api/customers/{id}", createdCustomer2.getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.name", is("Tenant2 Premium Customer - Upgraded")));
            ...
            mockMvc.perform(
                            delete("/api/customers/{id}", createdCustomer3.getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.name", is("Tenant2 Standard Customer")));
            ...
            mockMvc.perform(
                            get("/api/customers/{id}", createdCustomer3.getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isNotFound());
        }
        ...
        void shouldMaintainDataIntegrityDuringComplexTenant2Operations() throws Exception {
            ...
            mockMvc.perform(
                            put("/api/customers/{id}", initialCustomers.get(0).getId())
                                    .param("tenant", TENANT_2)
                                    .contentType(MediaType.APPLICATION_JSON)
                                    .content(objectMapper.writeValueAsString(updateDto)))
                    .andExpect(status().isOk());
            ...
            mockMvc.perform(
                            delete("/api/customers/{id}", initialCustomers.get(1).getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk());
            ...
            mockMvc.perform(
                            get("/api/customers/{id}", initialCustomers.get(0).getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.name", is("T2 Customer Alpha - Modified")));

            mockMvc.perform(
                            get("/api/customers/{id}", initialCustomers.get(2).getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.name", is("T2 Customer Gamma")));

            mockMvc.perform(
                            get("/api/customers/{id}", createdCustomer.getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk())
            ...
            mockMvc.perform(
                            get("/api/customers/{id}", initialCustomers.get(1).getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isNotFound());
        }
        ...
        void shouldHandleEdgeCasesSpecificToTenant2() throws Exception {
            ...
            Customer createdLongNameCustomer =
                    objectMapper.readValue(longNameResponse, Customer.class);
            ...
            mockMvc.perform(
                            put("/api/customers/{id}", createdLongNameCustomer.getId())
                                    .param("tenant", TENANT_2)
                                    .contentType(MediaType.APPLICATION_JSON)
    ...
    class AdvancedMultiTenantScenarios {
        ...
        void shouldHandleRapidTenantSwitchingOperations() throws Exception {
            ...
            mockMvc.perform(
                            put("/api/customers/{id}", t1c1.getId())
                                    .param("tenant", TENANT_1)
                                    .contentType(MediaType.APPLICATION_JSON)
            ...
            mockMvc.perform(
                            put("/api/customers/{id}", t2c1.getId())
                                    .param("tenant", TENANT_2)
                                    .contentType(MediaType.APPLICATION_JSON)
        ...
        void shouldEnsureCompleteIsolationBetweenTenantOperations() throws Exception {
            ...
            List<String> t2CustomerNames =
                    List.of("T2 Startup Inc", "T2 Creative Agency", "T2 Consulting Group");
            ...
            for (Customer t2Customer : t2Customers) {
                mockMvc.perform(
                                get("/api/customers/{id}", t2Customer.getId())
                                        .param("tenant", TENANT_1))
                        .andExpect(status().isNotFound());
            }
            ...
            for (Customer t1Customer : t1Customers) {
                mockMvc.perform(
                                get("/api/customers/{id}", t1Customer.getId())
                                        .param("tenant", TENANT_2))
                        .andExpect(status().isNotFound());
            }
            ...
            for (Customer t1Customer : t1Customers) {
                mockMvc.perform(
                                put("/api/customers/{id}", t1Customer.getId())
                                        .param("tenant", TENANT_2)
                                        .contentType(MediaType.APPLICATION_JSON)
                                        .content(objectMapper.writeValueAsString(updateDto)))
                        .andExpect(status().isNotFound());
            ...
            for (Customer t1Customer : t1Customers) {
                mockMvc.perform(
                                delete("/api/customers/{id}", t1Customer.getId())
                                        .param("tenant", TENANT_2))
                        .andExpect(status().isNotFound());
            }
    ...
    class BusinessLogicTests {
        ...
        void shouldHandleComplexTenant2BusinessScenarios() throws Exception {
            ...
            List<String> importedCustomerNames =
                    List.of(
                            "Legacy Customer 001",
                            "Legacy Customer 002",
                            "Legacy Customer 003",
            ...
            mockMvc.perform(
                            delete("/api/customers/{id}", toArchive1.getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk());

            mockMvc.perform(
                            delete("/api/customers/{id}", toArchive2.getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk());
            ...
            mockMvc.perform(
                            get("/api/customers/{id}", importedCustomers.get(0).getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.name", is("Tenant2 Modern Customer 1")));

            mockMvc.perform(
                            get("/api/customers/{id}", importedCustomers.get(2).getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.name", is("Tenant2 Modern Customer 3")));

            mockMvc.perform(
                            get("/api/customers/{id}", importedCustomers.get(4).getId())
                                    .param("tenant", TENANT_2))
                    .andExpect(status().isOk())
