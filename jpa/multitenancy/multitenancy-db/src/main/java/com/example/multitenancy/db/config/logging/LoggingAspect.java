package com.example.multitenancy.db.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
            """
            @within(com.example.multitenancy.db.config.logging.Loggable) || \
            @annotation(com.example.multitenancy.db.config.logging.Loggable)\
            """)
