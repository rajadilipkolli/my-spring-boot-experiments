package com.example.envers.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("@within(com.example.envers.config.logging.Loggable) || "
            + "@annotation(com.example.envers.config.logging.Loggable)")
