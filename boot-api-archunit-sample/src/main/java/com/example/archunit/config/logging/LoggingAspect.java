package com.example.archunit.config.logging;
...
class LoggingAspect {
    ...
    @Pointcut("@within(com.example.archunit.config.logging.Loggable) || "
            + "@annotation(com.example.archunit.config.logging.Loggable)")
