...
import com.example.archunit.exception.ResourceNotFoundException;
import java.net.URI;
...
public class GlobalExceptionHandler {
    ...
    ProblemDetail onException(Exception exception) {
        if (exception instanceof ResourceNotFoundException resourceNotFoundException) {
            ...
            problemDetail.setType(URI.create("http://api.boot-api-archunit-sample.com/errors/not-found"));
