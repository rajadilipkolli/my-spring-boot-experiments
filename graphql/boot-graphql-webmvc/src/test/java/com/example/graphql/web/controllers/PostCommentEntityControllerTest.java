...
class PostCommentEntityControllerTest {
    ...
    void shouldReturn404WhenFetchingNonExistingPostComment() throws Exception {
        ...
        this.mockMvc.perform(get("/api/post/comments/{id}", postCommentId)).andExpect(status().isNotFound());
    }
    ...
    void shouldReturn400WhenCreateNewPostCommentWithoutText() throws Exception {
        ...
        this.mockMvc
                .perform(post("/api/post/comments")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonMapper.writeValueAsString(postComment)))
    ...
    void shouldDeletePostComment() throws Exception {
        ...
        this.mockMvc
                .perform(delete("/api/post/comments/{id}", postCommentId))
