...
class ReactiveCommentsControllerIT extends AbstractIntegrationTest {
    ...
    void shouldReturn400WhenCreateNewReactiveCommentsWithoutTitleAndContent() {
        ...
        this.webTestClient
                ...
                .expectBody()
                .jsonPath("$.type")
                .isEqualTo("https://api.boot-r2dbc.com/validation-error")
                .jsonPath("$.title")
                ...
                .jsonPath("$.properties.violations[2].object")
                .isEqualTo("reactiveCommentRequest")
                .jsonPath("$.properties.violations[2].field")
                .isEqualTo("title")
                .jsonPath("$.properties.violations[2].rejectedValue")
                .isEmpty()
                .jsonPath("$.properties.violations[2].message")
