package com.example.opensearch.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("@within(com.example.opensearch.config.logging.Loggable) || "
            + "@annotation(com.example.opensearch.config.logging.Loggable)")
