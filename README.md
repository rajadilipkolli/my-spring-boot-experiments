...
| [Custom SequenceNumber and LazyConnectionDataSourceProxy for db connection improvement](./jpa/boot-data-customsequence) | Highlights creating custom sequence generators and optimizing database connections.                         |
