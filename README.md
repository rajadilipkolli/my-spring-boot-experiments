...
| [my-spring-graphql-querydsl](./graphql/my-spring-graphql-querydsl)                                | The application, demonstrates the way to connect to database using graph ql and querydsl                                                                                       | WIP       |
