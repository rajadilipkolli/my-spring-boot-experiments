package com.example.restdocs.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("@within(com.example.restdocs.config.logging.Loggable) || "
            + "@annotation(com.example.restdocs.config.logging.Loggable)")
